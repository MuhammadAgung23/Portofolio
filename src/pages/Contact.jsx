        ...
        <div className="w-full max-w-[1200px] flex flex-col gap-16">
          ...
          <div className="flex flex-col gap-6 text-center md:text-left md:flex-row md:items-end md:justify-between">
            ...
            <div className="flex gap-4 md:gap-6 justify-center md:justify-end">
              {/* Mail Icon */}
              <a className="group flex items-center justify-center size-12 rounded-full bg-slate-200 dark:bg-slate-800 hover:bg-primary dark:hover:bg-primary transition-all duration-300" href="mailto:emailmu@example.com">
                <span className="material-symbols-outlined text-slate-600 dark:text-slate-400 group-hover:text-white">mail</span>
              </a>
              {/* LinkedIn Icon (SVG) */}
              <a className="group flex items-center justify-center size-12 rounded-full bg-slate-200 dark:bg-slate-800 hover:bg-primary dark:hover:bg-primary transition-all duration-300" href="#">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a className="text-base font-semibold text-slate-900 dark:text-white hover:text-primary transition-colors" href="mailto:hello@devportfolio.com">hello@devportfolio.com</a>
                    </div>
                  </div>
                  {/* Phone */}
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a className="text-base font-semibold text-slate-900 dark:text-white hover:text-primary transition-colors" href="tel:+1234567890">+1 (555) 123-4567</a>
                    </div>
                  </div>
                  {/* Location */}
                  <div className="flex items-start gap-4">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <label className="flex flex-col flex-1">
                    <p className="text-slate-900 dark:text-white text-sm font-semibold leading-normal pb-2">Your Name</p>
                    <input className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-[#3b4754] bg-slate-50 dark:bg-[#10151a] h-12 placeholder:text-slate-400 dark:placeholder:text-[#9dabb9] px-4 text-base font-normal leading-normal transition-all" placeholder="John Doe" type="text" required />
                  </label>
                  <label className="flex flex-col flex-1">
                    <p className="text-slate-900 dark:text-white text-sm font-semibold leading-normal pb-2">Email Address</p>
                    <input className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-[#3b4754] bg-slate-50 dark:bg-[#10151a] h-12 placeholder:text-slate-400 dark:placeholder:text-[#9dabb9] px-4 text-base font-normal leading-normal transition-all" placeholder="john@example.com" type="email" required />
                  </label>
                </div>
                <label className="flex flex-col flex-1">
                  <p className="text-slate-900 dark:text-white text-sm font-semibold leading-normal pb-2">Subject</p>
                  <input className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-[#3b4754] bg-slate-50 dark:bg-[#10151a] h-12 placeholder:text-slate-400 dark:placeholder:text-[#9dabb9] px-4 text-base font-normal leading-normal transition-all" placeholder="Project Proposal" type="text" />
                </label>
                <label className="flex flex-col flex-1">
                  <p className="text-slate-900 dark:text-white text-sm font-semibold leading-normal pb-2">Message</p>
                  <textarea className="flex w-full min-w-0 flex-1 resize-y overflow-hidden rounded-lg text-slate-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-[#3b4754] bg-slate-50 dark:bg-[#10151a] min-h-[160px] placeholder:text-slate-400 dark:placeholder:text-[#9dabb9] p-4 text-base font-normal leading-normal transition-all" placeholder="Tell me about your project needs, timeline, and goals..." required></textarea>
                </label>
                <div className="flex items-center justify-between pt-2">
                  <p className="hidden md:block text-xs text-slate-500 dark:text-slate-400">
                    * I usually respond within 24 hours.
                  </p>
                  <button type="submit" className="flex min-w-[140px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-primary hover:bg-blue-600 active:bg-blue-700 transition-all text-white text-base font-bold leading-normal tracking-[0.015em] shadow-lg shadow-primary/20">
